...
You are responsible for the `level_design` workstream.
...
- docs/contracts/level_design_contract.md
- workstreams/level_design/BRIEF.md
- docs/rubrics/handoff_quality_rubric.md

## Dependency Reason

Level design owns spatial pacing, activity placement, and skill-gated locations.
...
Design regions, player route, activity placement, resource distribution, risk placement, and pacing.
...
Work only inside workstreams/level_design/ unless explicitly authorized.
