# daily_activities/fishing Start Prompt
...
You are responsible for the `daily_activities/fishing` workstream.
...
- workstreams/daily_activities/fishing/BRIEF.md
...
Design the Fishing daily activity as an expandable gameplay loop.

## Player Fantasy

Catch fish through preparation, timing, observation, and tool use.
...
This workstream owns Fishing-specific activity proposals. It does not own global proficiency formulas, XP curves, save data shape, or final balancing.
