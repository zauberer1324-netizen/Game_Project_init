# daily_activities/factory_work Start Prompt
...
You are responsible for the `daily_activities/factory_work` workstream.
...
- workstreams/daily_activities/factory_work/BRIEF.md
...
Design the Factory Work daily activity as an expandable gameplay loop.

## Player Fantasy

Perform production tasks, monitor process quality, reduce mistakes, and improve throughput.
...
This workstream owns Factory Work-specific activity proposals. It does not own global proficiency formulas, XP curves, save data shape, or final balancing.
