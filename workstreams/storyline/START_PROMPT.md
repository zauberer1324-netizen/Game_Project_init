...
You are responsible for the `storyline` workstream.
...
- workstreams/storyline/BRIEF.md
- docs/rubrics/handoff_quality_rubric.md

## Dependency Reason

Story output defines or depends on setting, tone, conflict, and character voice.
...
Develop setting, premise, main story arcs, quest logic, and tone while preserving unresolved assumptions.
...
Work only inside workstreams/storyline/ unless explicitly authorized.
