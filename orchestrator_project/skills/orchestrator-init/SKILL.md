...
description: Initializes a game project before parallel workstreams begin. Uses a grill-with-docs style interview to align game vision, context, contracts, first PRD, workstream briefs, and Orchestrator memory. Use when starting a new game project, resetting direction, or before opening specialist workstream chats.
---
...
This skill is not for implementation. It is for alignment, memory setup, and
...
- Workstream folders should not start serious work until the initial memory,
  contracts, PRD, and BRIEFs are ready.
...
8. existing `docs/prd/*`
9. existing `workstreams/*/BRIEF.md`
